...
def draw_cover(D, lobs, logo_path=None) -> bytes:
    ...
    c.drawString(52, H-370, "LINES OF BUSINESS INCLUDED IN THIS PROPOSAL:")
    chip_x = 52; chip_y = H-395; chip_h = 28
...
def build_body(D, logo_path=None) -> bytes:
    ...
    terms = [
        ...
        ("$10,000 Penalty for Breach", "Any unauthorized sharing of this proposal with a competitor of McDade Insurance will result in a minimum liquidated damages claim of <b>$10,000 (ten thousand dollars)</b> per occurrence."),
